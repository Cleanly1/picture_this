            ...
            <?php if (userLoggedIn()) { ?>
                <li class="navItem"><a href="/createPost.php" class="navLinks">
                    ...
                    <li class="navItem">
                        ...
                        <li class="navItem">
                            <a href="/app/users/logout.php" class="navLinks">
                                Logout
                            </a>
                        </li>
                    <?php } else { ?>
